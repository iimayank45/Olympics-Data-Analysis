...
st.sidebar.image('https://c4.wallpaperflare.com/wallpaper/443/195/686/olympic-bright-circle-colorful-wallpaper-preview.jpg')
...
if user_menu == 'Overall Analysis':
    ...
    nations_participation = helper.data_over_time(df, 'region')
    fig = px.line(nations_participation, x='Edition', y='region')
...
if user_menu == 'Athlete-wise Analysis':
    ...
    selected_sport = st.selectbox('Select a sport', sports_list)
    t = helper.weight_vs_height(df, selected_sport)
    fig, ax = plt.subplots()
    ax = sns.scatterplot(x='Weight', y='Height', data=t, hue = 'Medal', style='Sex', s = 60)
    st.pyplot(fig)
